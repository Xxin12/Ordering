    ...
    <#--底部导航-->
        ...
        <div style="width: 100%;  position:absolute; bottom:70px; z-index:99;">
            <div class="content-block" style="margin: 0;">
                <div class="row">
                    <div class="col-33"><a href="#" class="button button-big button-fill button-success " style="height: 1.7rem; line-height: 1.8rem;" onclick="window.location='${commonBaseUrl}/index.html'">继续点菜</a></div>
                    <div class="col-33"><a href="#" class="button button-big " style="height: 1.7rem; line-height: 1.8rem;">总价：￥ ${totals / 100}</a></div>
                    <div class="col-33"><a href="#" id="temporaryOrderFinished" class="button button-big button-fill button-success"
                                           style="height: 1.7rem; line-height: 1.8rem;" onclick="temporaryOrdersFinished(this)">上菜</a></div>
                </div>
            </div>
        </div>
    <#--页面内容展示-->
...
<script>
    ...
    function temporaryOrdersFinished() {

        request('${commonBaseUrl}/temporaryOrders/', requestType.POST, dataType.JSON, undefined, function () {
            location.reload();
        });
    }
